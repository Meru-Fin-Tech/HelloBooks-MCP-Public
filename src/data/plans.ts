...
export type PlanType = 'free' | 'pro' | 'cpa' | 'warehouse-addon' | 'manufacturing-addon';
...
// Pro repriced ~50% of v1 list. Anchors keep v1 monthly price for the strikethrough effect.
// Business tier removed; its features merged into Pro.
