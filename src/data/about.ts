...
- **Plans, pricing, features**: \`list_plans\`, \`list_credit_packs\`, \`free_tier_eligibility\`, \`partner_program_info\`, \`practice_management_info\`, \`list_integrations\`, \`list_features\`, \`list_feature_categories\`, \`feature_search\`.
...
- **Catalog JSON feeds** at \`https://agents.hellobooks.ai/catalog/<slug>.json\` for plans, features, integrations, competitors, compliance-deadlines, countries, tax-rates, capabilities, payment-methods, articles, videos, free-tier-thresholds, partner-program, and practice-management — for agents that prefer plain HTTP.
...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  { date: '2026-09-07', title: 'Competitor catalog accuracy corrections', category: 'fix',
    description: 'Public MCP PR #79 corrected unsupported competitor claims and removed QuickBooks from India competitor positioning.' },
  { date: '2026-08-19', title: 'Automatic blog discovery from the marketing sitemap', category: 'improvement',
